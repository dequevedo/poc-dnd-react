  ...
  render() {
    return (
      <div>
        ...
        <Grid container spacing={0.1}>
          <Grid xs={6}>
            <DropdownSelector label="Alinhamento" values={["Ordeiro e bom", "Neutro e bom", "Caótico e bom", "Ordeiro e neutro", "Neutro", "Caótico e neutro", "Ordeiro e mau", "Neutro e mau", "Caótico e mau"]}/>
          </Grid>
          <Grid xs={6}>
